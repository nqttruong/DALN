...
danh_sach_ten_thu_muc = ["Panasonic", "Sunhouse", "Philips", "Bear", "KAFF", "Electrolux",
    "Xiaomi", "Tefal", "Sharp", "Tiross", "Karofi", "SENKO", "Kangaroo",
    "Rinnai", "Elmich", "Kemei", "Toshiba", "Bosch", "Eurosun", "Robot",
    "Comet", "Ladomax", "Bluestone", "ERA", "Nagakawa", "BLAUBERG", "Kuvings",
    "SMY", "DeLonghi", "HAFELE"]
