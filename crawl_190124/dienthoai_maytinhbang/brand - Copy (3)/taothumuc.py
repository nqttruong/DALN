...
danh_sach_ten_thu_muc = ["Samsung", "Xiaomi", "OPPO", "Masstel", "Panasonic", "Kindle", "Nokia", "Oukitel",
                   "Ulefone", "Apple", "Tecno", "Realme", "Vivo", "Itel", "Forme", "Kobo", "Onyx Boox",
                   "Mobell", "Yealink", "Cisco", "TCL", "Bphone", "Grandstream", "Huawei", "Massel",
                   "Vankyo", "Vtel", "ZTE", "Alcatel", "China Mobile"]
